          ...
          >
            ...
            >
              <div>
                ...
                <div
                  class="mt-1 text-base font-medium text-slate-600 whitespace-nowrap"
                >
                  $2,367,01
                </div>
              </div>
            ...
            >
              <div>
                <div class="flex items-center text-slate-500 whitespace-nowrap">
                  Volume
                  <span
                    class="px-1.5 py-px ml-1.5 text-xs border rounded-md bg-slate-100/80 text-slate-500"
                  >
                    24h
                  </span>
      ...
      <div>
        ...
        <div class="p-5 mt-3.5 box box--stacked">
          ...
          <div class="flex flex-col gap-3 mt-4 sm:items-center sm:flex-row">
            <div
              class="flex items-center flex-1 border rounded-lg bg-slate-50/80"
            >
              <a
                href=""
                class="flex-1 px-3 py-2 text-center border-r border-dashed last:border-r-0 text-slate-500 hover:bg-slate-100 bg-slate-100"
              >
                1.5%
              </a>
              <a
