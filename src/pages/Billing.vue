    ...
    >
      <div>
        ...
        <div class="p-5 mt-3.5 box box--stacked">
          <div
            class="flex flex-col p-5 border border-dashed rounded-lg gap-y-8 lg:items-center lg:flex-row bg-slate-50/60"
          >
            ...
            <div class="lg:ml-auto">
              <div class="flex flex-col gap-3 md:flex-row">
                <Button
                  ...
                  class="px-4 border-slate-300/80 bg-slate-100/70"
                >
                  <Lucide
                    icon="ShieldX"
          ...
          <div class="flex h-2 mt-3.5">
            ...
            ></div>
            <div
              class="h-full first:rounded-l last:rounded-r border border-slate-300 bg-slate-100 w-[40%]"
            ></div>
          </div>
      ...
      <div>
        ...
        <div class="p-5 mt-3.5 box box--stacked">
          ...
          >
            ...
            >
              <div
                class="flex items-center px-5 pt-3 pb-4 border-b border-dashed border-slate-300/80 last:border-0 hover:bg-slate-50"
              >
                <FormCheck.Input
          ...
          <div
            class="flex gap-y-3 flex-col lg:flex-row lg:items-center px-5 py-3.5 mt-5 border rounded-lg bg-slate-50/80 border-slate-200/80"
          >
            <div>
      ...
      <div>
        ...
        <div class="mt-3.5 box box--stacked">
            ...
            <div class="overflow-auto xl:overflow-visible">
              <Table>
                <Table.Thead>
                  <Table.Tr>
                    <Table.Td
                      class="py-4 font-medium bg-slate-50 first:rounded-tl-[0.6rem] last:rounded-tr-[0.6rem] border-slate-200/80 text-slate-500"
                    >
                      Transaction ID
                    </Table.Td>
                    <Table.Td
                    ...
                    <Table.Td
                      class="py-4 text-center font-medium bg-slate-50 first:rounded-tl-[0.6rem] last:rounded-tr-[0.6rem] border-slate-200/80 text-slate-500"
                    >
                      Invoice
                    </Table.Td>
                    <Table.Td
          ...
          <div class="flex justify-end w-full p-5">
            <Button
              variant="outline-primary"
              class="w-full px-6 bg-white sm:w-auto text-primary border-primary/30 hover:bg-primary/20"
            >
