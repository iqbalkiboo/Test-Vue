  ...
  <div class="grid grid-cols-12 gap-y-10 gap-x-6">
    <div class="col-span-12">
      <div class="p-1.5 box flex flex-col box--stacked">
        ...
        <div class="rounded-[0.6rem] bg-slate-50 pt-12 pb-6">
      ...
      >
        <div class="flex flex-col 2xl:items-center 2xl:flex-row gap-y-3">
          <Tab.List
            variant="boxed-tabs"
            class="flex-col sm:flex-row w-full 2xl:w-auto mr-auto bg-white box rounded-[0.6rem] border-slate-200"
          >
            <Tab
                ...
                <div class="flex flex-col gap-y-7">
                  ...
                  <div class="grid grid-cols-1 lg:grid-cols-2 gap-y-10 gap-x-6">
                    <div class="flex flex-col p-5 box box--stacked">
                      ...
                      <Button
                        variant="primary"
                        class="w-full mt-5 bg-white border-dashed text-primary border-primary/20 hover:bg-primary/20"
                      >
                        View All Messages
                        <Lucide
                          icon="ArrowRight"
                  ...
                  <div class="flex flex-col box box--stacked">
                            ...
                            <Table.Tr class="[&_td]:last:border-b-0">
                              ...
                              >
                                <div class="w-40">
                                  ...
                                  <div
                                    class="flex h-1 border rounded-sm bg-slate-50 mt-1.5"
                                  >
                                    <div
                                      :class="[
                    ...
                    <div class="p-5">
                      <Button
                        variant="primary"
                        class="w-full bg-white border-dashed text-primary border-primary/20 hover:bg-primary/20"
                      >
                        View All Projects
                        <Lucide
                          icon="ArrowRight"
              ...
              >
                <div class="sticky flex flex-col top-[6.2rem] gap-y-7">
                  <div class="flex flex-col p-5 box box--stacked">
                    ...
                    <Button
                      variant="primary"
                      class="w-full mt-5 bg-white text-primary border-primary/20 hover:bg-primary/20"
                    >
