      ...
      <div class="gap-5 flex flex-col sm:flex-row mt-3.5">
        ...
        <div class="flex flex-col w-full box box--stacked">
          ...
          <div class="flex flex-col gap-6 px-5">
            <div>
              <div
                class="h-4 mt-1 mb-5 text-xs uppercase text-slate-500/60 relative before:content-[''] before:h-px before:bg-slate-200/70 before:w-full before:absolute before:inset-y-0 before:my-auto"
              >
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-y-3.5 gap-x-4">
                ...
                >
                  <div>
                    <div
                      class="flex items-center relative px-3 py-2.5 rounded-[0.6rem] border border-slate-200/80 hover:bg-slate-50 cursor-pointer transition sm:px-5 shadow-sm"
                    >
                      <div class="">
                        <FormCheck.Input
                          class="-mt-1 border"
