      ...
      <Tab.Group>
        ...
        <Tab.Panels class="mt-3.5 box box--stacked">
          ...
          >
            <div class="grid w-full grid-cols-4 gap-2">
              ...
              >
                ...
                <div class="flex items-center mt-12">
                  ...
                  <div
                    class="flex items-center ml-3.5 border border-success/50 bg-success/50 rounded-full pl-[7px] pr-1 py-[2px] text-xs font-medium text-white/90"
                  >
                    12%
                    <Lucide
                      icon="ChevronUp"
              ...
              <div
                class="col-span-4 sm:col-span-2 xl:col-span-1 flex-1 p-5 border relative rounded-[0.6rem] bg-slate-50/50 overflow-hidden"
              >
                <div
            ...
            <a
              href=""
              class="bg-slate-50 xl:w-20 text-slate-400/80 flex flex-col justify-center items-center p-5 border border-slate-300/80 rounded-[0.6rem] hover:bg-slate-50 border-dashed [&:hover_svg]:rotate-180"
            >
              <Lucide
                icon="PlusSquare"
    ...
    <div class="flex flex-col col-span-12 xl:col-span-6 gap-y-10">
      <div>
        ...
        <div class="p-5 mt-3.5 box box--stacked">
          ...
          <div>
            <div
              class="flex items-center w-full px-3 py-3 font-medium border rounded-lg bg-slate-50 text-slate-500"
            >
