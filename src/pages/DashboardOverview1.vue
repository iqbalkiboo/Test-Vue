      ...
      <div class="flex flex-col md:h-10 gap-y-3 md:items-center md:flex-row">
        ...
        <div class="flex flex-col sm:flex-row gap-x-3 gap-y-2 md:ml-auto">
          <div class="relative">
            ...
            />
            <FormSelect
              class="sm:w-44 rounded-[0.5rem] group-[.mode--light]:bg-chevron-white group-[.mode--light]:!bg-white/[0.12] group-[.mode--light]:!text-slate-200 group-[.mode--light]:!border-transparent pl-9"
            >
          ...
          <div class="relative">
            ...
            <Litepicker
              ...
              class="pl-9 sm:w-64 rounded-[0.5rem] group-[.mode--light]:!bg-white/[0.12] group-[.mode--light]:!text-slate-200 group-[.mode--light]:!border-transparent"
            />
          </div>
        </div>
      </div>
